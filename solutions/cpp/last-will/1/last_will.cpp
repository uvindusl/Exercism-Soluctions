...
int assemble_code() {
    int sum_of_blues = zhang::blue::code_fragment() + khan::blue::code_fragment() +                                             garcia::blue::code_fragment();
    int sum_of_reds = zhang::red::code_fragment() + khan::red::code_fragment() +                                               garcia::red::code_fragment();

    return sum_of_blues * sum_of_reds;
